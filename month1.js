const text =
  ...
  function dashOut(arr) {
    if (i < arr.length && !isFastForwarding) {
      ...
      if (!breakInserted && typedText.endsWith("on to december now bubba!")) {
        typedText += "<br><br>"; 
        breakInserted = true;
      }
  ...
  function fastForward() {
    ...
    fullText = fullText.replace("on to december now bubba!,", "on to december now bubba!,<br><br>");
